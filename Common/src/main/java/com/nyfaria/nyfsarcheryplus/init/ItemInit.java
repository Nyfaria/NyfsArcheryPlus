...
public class ItemInit {
	...
	public static final RegistrationProvider<Item> ITEMS = RegistrationProvider.get(Registry.ITEM_REGISTRY, Constants.MODID);
	...
	public static final ArcheryCollection<Item> STONE_COLLECTION = new ArcheryCollection<>(ArcheryTiers.STONE,null,null, ITEMS.register("stone_arrowhead", () -> new Item(new Item.Properties().stacksTo(64))),ITEMS.register("stone_tipped_arrow", () -> new AdvancedTippedArrowItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT),ArcheryTiers.STONE)));
