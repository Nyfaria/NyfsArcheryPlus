...
public class RecipeInit {
    ...
    public static final RegistryObject<RecipeSerializer<AdvancedTippedArrowRecipe>> ADVANCED_TIPPED_ARROW = RECIPES.register("advanced_tipped_arrow", () -> new SimpleCraftingRecipeSerializer<>(AdvancedTippedArrowRecipe::new));
