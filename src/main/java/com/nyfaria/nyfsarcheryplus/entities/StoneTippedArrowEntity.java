...
public class StoneTippedArrowEntity extends AbstractArrowEntity {
	...
	public StoneTippedArrowEntity(EntityType typeIn, LivingEntity player, World world) {
		super(typeIn, player, world);
		this.setBaseDamage(3);
	}
	
    public StoneTippedArrowEntity(EntityType<? extends AbstractArrowEntity> stoneTippedArrowItem, World worldIn, double x, double y,
			double z) {
