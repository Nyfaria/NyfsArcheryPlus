...
public class RenderDiamondTippedArrow extends ArrowRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("nyfsarcheryplus:textures/models/arrows/diamond_tipped_arrow.png");

    public RenderDiamondTippedArrow(EntityRendererProvider.Context render) {
        super(render);
    }
