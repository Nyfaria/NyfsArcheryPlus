...
public class RenderStoneTippedArrow extends ArrowRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("nyfsarcheryplus:textures/models/arrows/stone_tipped_arrow.png");

    public RenderStoneTippedArrow(EntityRendererProvider.Context render) {
        super(render);
    }
