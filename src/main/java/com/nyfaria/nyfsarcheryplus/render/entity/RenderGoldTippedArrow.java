...
public class RenderGoldTippedArrow extends ArrowRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("nyfsarcheryplus:textures/models/arrows/gold_tipped_arrow.png");

    public RenderGoldTippedArrow(EntityRendererProvider.Context render) {
        super(render);
    }
