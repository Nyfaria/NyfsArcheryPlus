...
public class RenderNetheriteTippedArrow extends ArrowRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("nyfsarcheryplus:textures/models/arrows/netherite_tipped_arrow.png");

    public RenderNetheriteTippedArrow(EntityRendererProvider.Context render) {
        super(render);
    }
